---@class SimpleClock : Control, TopLevelWindow
SimpleClock = SimpleClock
---@class SimpleClockLabel : Control, LabelControl
SimpleClockLabel = SimpleClockLabel
---@class SimpleClockOptions : Control
SimpleClockOptions = SimpleClockOptions
